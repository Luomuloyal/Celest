...
class CompetitionSections extends StatefulWidget {
  const CompetitionSections({super.key});

  @override
  State<CompetitionSections> createState() => _CompetitionPageState();
}

class _CompetitionPageState extends State<CompetitionSections> {
