...
class DashboardCountdownContent {
  const DashboardCountdownContent({
...
class DashboardLiveUpdateData {
  const DashboardLiveUpdateData({
    required this.icon,
    required this.title,
    required this.subtitle,
    required this.tint,
...
class DashboardBenchmarkCaseContent {
  const DashboardBenchmarkCaseContent({
...
abstract final class DashboardMockData {
  ...
  static const DashboardHeroContent hero = DashboardHeroContent(
    title: '欢迎回来, Alex',
  ...
  static const DashboardCountdownContent countdown = DashboardCountdownContent(
    statusLabel: '报名中',
    title: '全国创新挑战赛',
  ...
  static const List<DashboardQuickActionData> quickActions =
  ...
  static const List<DashboardLiveUpdateData> liveUpdates =
      <DashboardLiveUpdateData>[
        DashboardLiveUpdateData(
  ...
  static const DashboardBenchmarkCaseContent
  benchmarkCase = DashboardBenchmarkCaseContent(
