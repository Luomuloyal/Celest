    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final showPrimarySplit =
            contentWidth >= HomeMockData.primarySplitMinWidth;
        final showSecondarySplit =
            contentWidth >= HomeMockData.secondarySplitMinWidth;
...
class _DashboardHero extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final titleSize = (contentWidth * HomeMockData.heroTitleScaleFactor)
        .clamp(
          HomeMockData.heroTitleMinSize,
          HomeMockData.heroTitleMaxSize,
        )
        .toDouble();
    final subtitleSize =
        (contentWidth * HomeMockData.heroSubtitleScaleFactor)
            .clamp(
              HomeMockData.heroSubtitleMinSize,
              HomeMockData.heroSubtitleMaxSize,
            )
            .toDouble();
    final horizontalPadding =
        contentWidth < HomeMockData.heroCompactMaxWidth
        ? AppSpacing.lg
        : AppSpacing.xxl;
    final verticalPadding = contentWidth < HomeMockData.heroCompactMaxWidth
        ? AppSpacing.lg
        : AppSpacing.xl;
    ...
    return ClipRRect(
      ...
      child: Stack(
        children: [
          ...
          AppHeroBanner(
            title: HomeMockData.hero.title,
            subtitle: HomeMockData.hero.subtitle,
            actionLabel: HomeMockData.hero.actionLabel,
            ...
            gradientColors: HomeMockData.hero.gradientColors,
          ),
        ],
      ),
    );
...
class _CompetitionCountdownCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final countdown = HomeMockData.countdown;
    ...
    return AppSectionCard(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final compact =
              constraints.maxWidth < HomeMockData.heroCompactMaxWidth;
        ...
        builder: (context, constraints) {
          final aspectRatio =
              constraints.maxWidth <
                  HomeMockData.quickActionCompactMaxWidth
              ? 1.0
              : HomeMockData.quickActionAspectRatio;

          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const AppSectionHeader(title: HomeMockData.quickActionTitle),
              const SizedBox(height: AppSpacing.md),
              GridView.builder(
                shrinkWrap: true,
...
class _LiveUpdatesCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final liveUpdates = HomeMockData.liveUpdates;
      ...
      child: Column(
        ...
        children: [
          const AppSectionHeader(
            title: HomeMockData.liveUpdateTitle,
            actionLabel: HomeMockData.liveUpdateActionLabel,
          ),
...
class _BenchmarkCaseCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final benchmarkCase = HomeMockData.benchmarkCase;
            ...
            children: [
              const Expanded(
                child: AppSectionHeader(
                  title: HomeMockData.benchmarkTitle,
                ),
              ),
